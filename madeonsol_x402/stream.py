...
# Channels you can subscribe to (mirrors the server registry,
# services/shared/stream-channels.mjs).
CHANNELS = (
    "kol:trades",
    "kol:coordination",
    "kol:first_touches",
...
class MadeOnSolStream:
    ...
    def subscribe(self, channels: List[str], filters: Optional[Dict[str, Any]] = None, *,
                  sub_id: Optional[str] = None) -> "MadeOnSolStream":
    ...
    def update_subscription(self, sub_id: str, filters: Dict[str, Any]) -> "MadeOnSolStream":
